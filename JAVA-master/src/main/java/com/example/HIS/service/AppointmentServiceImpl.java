...
public class AppointmentServiceImpl implements AppointmentService{
    ...
    @Override
    public List<DoctorRemain> getAllDoctorRemain() {
    ...
    @Override
    public List<ReserveHistory> getReserveHistoryByPatientId(String patientIdentity) {
        return reserveTableDao.selectByPatientId(patientIdentity);
    }

    @Override
    public void updateReserveState(ReserveTable reserveId) {
        reserveTableDao.updateByPrimaryKey(reserveId);
    }
